package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class PostGameBanterModal extends ContentHolder
	{
		...
		public function PostGameBanterModal() 
		{
		...
		override protected function buildFrom(a_img:Sprite, a_buildFromAllDescendants:Boolean = true):Dictionary
		{
			...
			{
				throw new Error("PostGameBanterModal::buildFrom(): _playerOnePortrait=" + _playerOnePortrait);
			}
			...
			{
				throw new Error("PostGameBanterModal::buildFrom(): _playerTwoPortrait=" + _playerTwoPortrait);
			}
			...
			{
				throw new Error("PostGameBanterModal::buildFrom(): _playerOneBanter=" + _playerOneBanter);
			}
			...
			{
				throw new Error("PostGameBanterModal::buildFrom(): _playerTwoBanter=" + _playerTwoBanter);
			}
