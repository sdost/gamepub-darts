package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class EndGameBanterModal extends ContentHolder
	{
		...
		public function EndGameBanterModal() 
		{
		...
		override protected function buildFrom(a_img:Sprite, a_buildFromAllDescendants:Boolean = true):Dictionary
		{
			...
			{
				throw new Error("EndGameBanter::buildFrom(): _playerOnePortrait=" + _playerOnePortrait);
			}
			...
			{
				throw new Error("EndGameBanter::buildFrom(): _playerTwoPortrait=" + _playerTwoPortrait);
			}
			...
			{
				throw new Error("EndGameBanter::buildFrom(): _playerOneBanter=" + _playerOneBanter);
			}
			...
			{
				throw new Error("EndGameBanter::buildFrom(): _playerTwoBanter=" + _playerTwoBanter);
			}
