package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class PlayerBanterModal extends ContentHolder
	{
		...
		public function PlayerBanterModal() 
		{
		...
		override protected function buildFrom(a_img:Sprite, a_buildFromAllDescendants:Boolean = true):Dictionary
		{
			...
			{
				throw new Error("PlayerBanterModal::buildFrom(): _playerOnePortrait=" + _playerOnePortrait);
			}
			...
			{
				throw new Error("PlayerBanterModal::buildFrom(): _playerTwoPortrait=" + _playerTwoPortrait);
			}
			...
			{
				throw new Error("PlayerBanterModal::buildFrom(): _playerOneBanter=" + _playerOneBanter);
			}
			...
			{
				throw new Error("PlayerBanterModal::buildFrom(): _playerTwoBanter=" + _playerTwoBanter);
			}
