package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class BasicThrowTutorialModal extends ContentHolder
	{
		public function BasicThrowTutorialModal() 
		{
			super(SpriteFactory.getSpriteByQualifiedName(AppSettings.instance.basicTutorialModalSprite), false, true);
		...
		private function dismissPopup():void
		{
			...
			DartsGlobals.instance.externalServices.setData("seenBasicThrowTutorial", true);
			DartsGlobals.instance.gameManager.pause(false);
		}//end handleClick()
		
	}//end BasicThrowTutorialModal
