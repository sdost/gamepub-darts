package com.bored.games.darts.ui 
{
	...
	public class MultiplayerGameConfirmScreen extends ContentHolder
	{
		...
		override protected function buildFrom(a_img:Sprite, a_buildFromAllDescendants:Boolean = true):Dictionary
		{
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _storeBtnImg=" + _storeBtnImg);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _opponentDetails=" + _opponentDetails);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _opponentBio=" + _opponentBio);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _abilityIconOne=" + _abilityIconOne);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _abilityIconTwo=" + _abilityIconTwo);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _abilityIconThree=" + _abilityIconThree);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _opponentAbilityIconOne=" + _opponentAbilityIconOne);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _opponentAbilityIconTwo=" + _opponentAbilityIconTwo);
			}
			...
			{
				throw new Error("MultiplayerGameConfirmScreen::buildFrom(): _opponentAbilityIconThree=" + _opponentAbilityIconThree);
			}
			*/
