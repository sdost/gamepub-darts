package com.bored.games.darts.ui.store 
{
	...
	public class PowerStoreItem extends StoreItem
	{
		...
		public function PowerStoreItem( a_icon:MovieClip, a_name:String, a_abilityRef:Ability, a_id:String, a_price:int ) 
		{
			super();
			
			_abilityRef = a_abilityRef;
			
			_itemStoreIcon = SpriteFactory.getSpriteByQualifiedName("com.bored.games.darts.assets.hud.PowerSlot_MC");
			var icon:MovieClip = a_icon;
