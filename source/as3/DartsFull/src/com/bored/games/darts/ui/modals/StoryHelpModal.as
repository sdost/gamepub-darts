package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class StoryHelpModal extends ContentHolder
	{
		private var _okayBtnImg:MovieClip;
		private var _okayBtn:MightyButton;
		
		public function StoryHelpModal() 
		{
			super(SpriteFactory.getSpriteByQualifiedName(AppSettings.instance.storyHelpModalSprite), false, true);
