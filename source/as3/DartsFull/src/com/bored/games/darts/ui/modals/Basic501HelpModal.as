package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class Basic501HelpModal extends ContentHolder
	{
		private var _okayBtnImg:MovieClip;
		private var _okayBtn:MightyButton;
		
		public function Basic501HelpModal() 
		{
			super(SpriteFactory.getSpriteByQualifiedName(AppSettings.instance.basic501HelpModalSprite), false, true);
