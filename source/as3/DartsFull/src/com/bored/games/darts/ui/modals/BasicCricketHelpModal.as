package com.bored.games.darts.ui.modals 
{
	 ...
	 * @author sam
	 */
	public class BasicCricketHelpModal extends ContentHolder
	{
		private var _okayBtnImg:MovieClip;
		private var _okayBtn:MightyButton;
		
		public function BasicCricketHelpModal() 
		{
			super(SpriteFactory.getSpriteByQualifiedName(AppSettings.instance.basicCricketHelpModalSprite), false, true);
